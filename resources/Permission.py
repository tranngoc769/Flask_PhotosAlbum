...
class PermisionForPhotoResource(Resource):
    ...
    def post():
      ...
      if (permission == None or permission.isdigit() == False or (str(permission) != '1' and str(permission) != '2')):
            return {'message': 'permission required 1 or 2 : found' +str(permission)}, HTTP_NotAccept['code']
